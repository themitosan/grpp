    ...
    "utils": {
        ...
        "help": {
            ...
            "fnList": {
                ...
                "updateAll": "GRPP will update all imported repos, excluding disabled repos.",
                ...
                "removeAllKeys": "Add this option along \"--repair\" flag to automatically remove all missing keys from database. (USE WITH CARE!)",
            ...
            "fnArgsList": {
                ...
                "processBatchFile=[NUMBER]": "Loads / updates all repos in a list generated by \"--updateAll\" option.\nIMPORTANT: It's not recommended using this option manually.",
            },
